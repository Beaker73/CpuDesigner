...
describe("cartesianProduct", () => {
    ...
    it("Simple Enumeration", () => {
        ...
        // assert
        const expectedResult = [0n, 1n, 2n, 3n].map(i => new FixedUInt(4n, i * 2n));
    ...
    it("Complex Enumeration", () => {
        // arrange
        var sets: HasValues[] = [
            new FixedUIntSet<string>(2n, [[1n, "A"], [3n, "B"]]),
            new FixedUInt(1n, 0n),
            new FixedUIntSet<number>(2n, [[0n, 0], [1n, 1], [2n, 2], [3n, 3]]),
            new FixedUInt(1n, 1n),
        ]
...
describe("intersect", () => {
    ...
    it("baseIntersect", () => {
        const set1 = [new FixedUInt(4n, 2n), new FixedUInt(4n, 5n), new FixedUInt(4n, 7n)];
        const set2 = [new FixedUInt(4n, 3n), new FixedUInt(4n, 7n), new FixedUInt(4n, 9n)];
        const result = [...intersect(set1, set2)];

        const expectedResult = [new FixedUInt(4n, 7n)];
    ...
    it("shifted bitsets", () => {
        ...
        // -----------------------
        // 000     010
        const expectedResult = [new FixedUInt(3n, 0n), new FixedUInt(3n, 2n)];
...
describe("overlap", () => {
    ...
    it("base overlap", () => {
        ...
        const set8 = [new FixedUInt(4n, 0n), new FixedUIntSet(4n, [0n, 1n, 15n])];

        // set of 12 bits, top 7 are always 0, so only first bit of set will match
        const set12 = [new FixedUInt(7n, 0n), new FixedUIntSet(5n, [0n, 1n, 3n, 7n, 15n, 31n])];
        ...
        const expectedResult = [...toFixedUInt(8n, [0n, 1n, 3n, 7n, 15n, 31n])];
